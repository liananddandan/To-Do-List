...
{
    public async Task<(IdentityResult, ApiResponseCode)> RegisterAsync(
    ...
    public async Task<(IdentityResult identityResult, ApiResponseCode code)> ChangePasswordAsync(
        string userId,
        string password)
    {
    ...
    public async Task<(ApiResponseCode code, MyUser? user)> GetUserByIdAsync(string userId)
    {
        ...
        return (user == null ? ApiResponseCode.UserNotFound : ApiResponseCode.UserFetchSuccess, user);
    }

    public async Task<(ApiResponseCode code, string? accessToken, string? refreshToken)> RefreshTokenAsync(
        string refreshToken)
    {
        ...
        return (
            ApiResponseCode.RefreshTokenSuccess,
